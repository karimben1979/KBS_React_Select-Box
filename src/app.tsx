...
export default class App extends React.Component<Props, {}> {
  ...
  handleDevStatusChange = (event, index, value) =>
    this.setState({ devStatusValue: value });
  handleFeatureCompletedChange = (event, index, value) =>
    this.setState({ featureCompValue: value });

  public render() {
    return (
      <div style={styles.root}>
        <h1>React Select-Box using Typescript</h1>
        <h2>SelectBoxes</h2>
